...
//�}�E�X����p�ϐ�
Mouse_State ms{};
float cSize = 1.0f;//�J�����̊��x�����p

//�J��������p�ϐ�
static bool   gCamAnglesInit = false;//�J�����p�x�������t���O
static XMFLOAT3 gCamTarget = { 0, 0, 0 };//�J���������_
static XMFLOAT3 gCamPos = { 0, 0, 0 };//�J�����ʒu
static float gYawDeg = 180.0f;//�J�����̐�����]�p�x
static float gPitchDeg = 15.0f;//�J�����̏㉺��]�p�x
static float gDistance = 8.0f;//�J�����ƒ����_�̋���
static const float kPitchMin = -75.0f;//�J�����̏㉺���x�p�x
static const float kPitchMax = 75.0f;
static XMFLOAT3 gTargetOffset = { 0.0f, 1.2f, 0.0f };//�J���������_�I�t�Z�b�g
static float gFollowLerp = 0.15f;//�J�����Ǐ]�̑���
...
// �t�@�C���擪�t�߂̊����̃J�����֘A��static�ϐ���`�̋߂��ɒǋL
...
>>>>>>> 80338d33966c3eb9ba2c064ba6aec6c9b3c08367
