...
void Player3D_Initialize(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	...
	g_Player3D.Model[PLAYER_ANIM_JUMP]->CustomEndTime = 53.0f; // --> use if need to cut the animation short/傾僯儊乕僔儑儞傪抁偔僇僢僩偡傞昁梫偑偁傞応崌偵巊梡偟傑偡
...
void Player3D_Move()
{
	...
	// 僉乕儃乕僪偺懚嵼偡傞戙昞揑側憖嶌僉乕傪僠僃僢僋乮墴偝傟偰偄傞側傜僉乕儃乕僪桪愭乯
	...
	// 桪愭儖乕儖丗ControllerMode 偵墳偠偰擖椡僜乕僗傪寛掕偡傞
	// 乮ControllerMode 偼忋偱 gPad.IsConnected() 傪婎偵偟偮偮丄僉乕儃乕僪擖椡偑偁傟偽 false 偵偟偰偄傞乯
...
void Player3D_setposition(XMFLOAT3 pos)
{
	...
	//	// 傕偟 player3D.cpp 撪偵 Firstposition 曄悢偑婛偵偁傞応崌偼偦偪傜偵傕戙擖偟偰偔偩偝偄丅
	//	// 椺: Firstposition = p->Position;
	//}
...
// =========================================================================================================
// 僞僀僩儖夋柺梡丗帺摦曕峴奐巒乮巜掕曽岦偵岦偒傪曄偊偰傑偭偡偖曕偔乯
// =========================================================================================================
